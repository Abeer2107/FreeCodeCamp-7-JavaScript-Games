document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(index){
        squares[i].onclick = function(){
            if(squares[index + 7].classList.contains('taken')){
                if(currentPlayer === 1 && !squares[index].classList.contains('taken')){ //Fixes changing other player's move bug
    ...
    function checkBoard() {
        //const that shows all winning states 
        //TODO: Replace with generic check
        const winningArrays = [
